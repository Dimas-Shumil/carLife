...
function mapWork(work) {
  return {
    ...
    cover: work.images.find((image) => image.kind === 'COVER') || null,
    gallery: work.images.filter((image) => image.kind === 'GALLERY'),
